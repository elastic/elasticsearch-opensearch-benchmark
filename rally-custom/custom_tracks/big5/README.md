...
This repository contains the "Big5" track for benchmarking Elasticsearch using Rally. The "Big5" track focuses on five essential areas in Elasticsearch performance and querying: Text Querying, Sorting, Date Histogram, Range Queries, and Terms Aggregation.
