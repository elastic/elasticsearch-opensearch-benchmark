...
- 1 Node pool for Elasticsearch with 6 `e2-standard-16` machines (64GB RAM and 16 CPUs)
- 1 Node pool for OpenSearch with 6 `e2-standard-16` machines (64GB RAM and 16 CPUs)
- 1 Node pool for Rally with 2 `e2-standard-4` machines (12GB RAM and 4 CPUs)
...
```bash
 kubectl apply -f rally-logging-es.yml rally-logging-os.yml
```
...
Once you get the CSV file, just feed it to `charts.py` and charts will come out the other side:
